 ...
 *
 * -----
 * drawTrapez() added by Nejc Saje <nejc.saje@gmail.com>
 *
 */
...
public class Graph {
    ...
    public void drawLine(Graphics g, double x1, double y1, double x2, double y2) {
        ...
        g2.drawLine(getPlotX(x1), getPlotY(y1), getPlotX(x2), getPlotY(y2));
    }
    
    public void drawTrapez(Graphics g, double x1, double y1, double x2, double y2, int color) {
    	Graphics2D g2 = (Graphics2D)g;
    	g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
    	
    	GeneralPath trapez = new GeneralPath(GeneralPath.WIND_EVEN_ODD, 4);
    	trapez.moveTo(getPlotX(x1), getPlotY(0));
    	trapez.lineTo(getPlotX(x1), getPlotY(y1));
    	trapez.lineTo(getPlotX(x2), getPlotY(y2));
    	trapez.lineTo(getPlotX(x2), getPlotY(0));
    	trapez.lineTo(getPlotX(x1), getPlotY(0));
    	trapez.closePath();
    	if (color == 0) {
